...
# import sqlite3  # Replaced with centralized database connection
import json
...
class EnhancedPointSystem:
    ...
    POINT_VALUES = {
        ...
        'comment_helpful': 25,  # +10 from original (helpful comments marked by admin)
        'comment_thread_starter': 15,  # +5 from original (starting discussion threads)
        'quality_comment': 30,  # +10 from original (high quality comments)
